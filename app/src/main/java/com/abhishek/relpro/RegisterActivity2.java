...
public class RegisterActivity2 extends AppCompatActivity implements View.OnClickListener {
    ...
    private String selectedCountry, selectedDistrict, selectedState;
    private TextView tvCountrySpinner, tvStateSpinner, tvDistrictSpinner;
    private Spinner countrySpinner, stateSpinner, districtSpinner;
    private ArrayAdapter<CharSequence> countryAdapter, stateAdapter, districtAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_register2);
        Button button=findViewById(R.id.cirSubmitButton);
        ...
        countrySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                stateSpinner = findViewById(R.id.spnstate);
                selectedCountry = countrySpinner.getSelectedItem().toString();

                int parentID = parent.getId();
                if (parentID == R.id.spncountry){
                    ...
                    stateSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            districtSpinner = findViewById(R.id.spncity);
                            selectedState = stateSpinner.getSelectedItem().toString();

                            int parentID = parent.getId();
                            if (parentID == R.id.spnstate){
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.cirSubmitButton:
                Intent inn1=getIntent();
                inn1=new Intent(RegisterActivity2.this,MainActivity.class);
                startActivity(inn1);
                break;
        }
    }
